...
<div class="djrv_rating_avg djreviews" data-wrapper="djrv-avg-<?php echo $item->id; ?>" data-object="<?php echo $item->id; ?>">
	<div class="djrv_item_rating djrv_rating small">
		...
		<span class="djrv_avg small">
			<?php echo $item->avg_rate; ?> <!--CUSTOMLABEL--> <span class="djrv_vote_cnt">( <?php 
