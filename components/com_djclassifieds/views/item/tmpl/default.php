	...
	<?php
		...
		if($this->item_payments==0){
		 $modules_djcf = &JModuleHelper::getModules('djcf-item-top-free');
			...
			<?php } ?>
			<?php 
			$itemtype = ' itemtype="http://schema.org/Offer" ';
		/*	if($this->category->schema_type){
				$itemtype = 'itemtype="http://schema.org/'.$this->category->schema_type.'"';
			}*/ ?>
						
<div class="dj-item<?php echo $item_class; ?>" itemscope <?php echo $itemtype; ?> >
<?php	
