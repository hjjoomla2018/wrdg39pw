...
$document= JFactory::getDocument();
	...
	if($view=='item' || $view=='items' || $view=='additem' || $view=='payment' || $view=='renewitem' || $view=='profileedit' || $view=='contact' || $view=='checkout' || $view=='registration' || $view=='api' || $view=='searchalerts' || $view=='profile'){
