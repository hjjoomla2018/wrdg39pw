		...
		<div class="tab-content">
			<div class="adminformlist tab-pane active" id="details">
				...
				<div id="plgParams_component" class="plgParams">
					...
					<?php if((int)$aid = $this->item->id) { 
					$link = '<strong><a href="'.JRoute::_('index.php?option=com_djmediatools&view=items&filter_category='.$aid.'').'" target="_blank">'.JText::_('COM_DJMEDIATOOLS_CUSTOM_ITEMS').'</a></strong>'; ?>
					<div class="alert alert-info">
						<?php echo JText::sprintf('COM_DJMEDIATOOLS_OPEN_CUSTOM_ITEMS', $link) ?>
					</div>
					<?php } ?>
