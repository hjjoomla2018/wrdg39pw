...
abstract class DJUploadHelper {
	...
	public static function getUploader($id = 'uploader', $settings = array()) {
		...
		";
			...
			$js .= "
					...
					// Flash settings
					flash_swf_url : '".JURI::root(true)."/administrator/components/$component/lib/upload/Moxie.swf',
					
					// Silverlight settings
					silverlight_xap_url : '".JURI::root(true)."/administrator/components/$component/lib/upload/Moxie.swf',";
			if($debug) $js .= "
		...
		$html = '<div id="'.$id.'"><p>You browser doesn\'t support HTML5, Flash, Silverlight and even HTML4! Please upgrade your browser!</p></div>';
	...
	public static function upload() {
		...
		if (!$chunks || $chunk == $chunks - 1) {
			...
			if (preg_match('/\.(php|shtml|pht|asp)/i', $filePath) || preg_match('/\.(php|shtml|pht|asp)/i', $fileNameOrg)) {
				@unlink($filePath);
