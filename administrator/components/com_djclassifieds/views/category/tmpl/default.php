...
?>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								if($this->category->id>0){
									...
									echo '<br /><br /><a class="button" href="javascript:void(0)" onclick="confirm_assign_fields('.$this->category->id.')" >'.JText::_('COM_DJCLASSIFIEDS_ASSIGN_CUSTOM_FIELDS_TO_SUBCATEGORIES').'</a>';
	...
	function confirm_assign_fields(id){	
		var answer = confirm ('<?php echo str_replace("'","\'",JText::_('COM_DJCLASSIFIEDS_ASSIGN_CUSTOM_FIELDS_TO_SUBCATEGORIES_WARNING'));?>');
		if (answer){
			 window.location="index.php?option=com_djclassifieds&task=category.assignFieldsSubcat&id="+id;	
		}
	}
	</script>
	<?php echo DJCFFOOTER; ?>