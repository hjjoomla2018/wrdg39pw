		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<?php */ ?>
					<th width="10%">
						<?php echo JHtml::_('grid.sort', 'COM_DJREVIEWS_FIELD_TYPE', 'a.type', $listDirn, $listOrder); ?>
					</th>
					<th width="5%">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<?php */ ?>
					<td class="center">
						<?php echo JText::_('COM_DJREVIEWS_OPT_' . $item->type); ?>
					</td>
					<td class="center">
						<?php echo ($item->type == 'rating' && $item->weight > 0) ? $item->weight : '-'; ?>
					</td>
					<td class="center">
