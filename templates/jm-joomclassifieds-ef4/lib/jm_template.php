...
class JMTemplate extends JMFTemplate {
	public function postSetUp() {
		...
		$JMmenuTopbarBackgroundColorActive = $this->params->get('JMmenuTopbarBackgroundColorActive', $this->defaults->get('JMmenuTopbarBackgroundColorActive'));
		$bootstrap_vars['JMmenuTopbarBackgroundColorActive'] = $JMmenuTopbarBackgroundColorActive;

		//menu border
		$JMtopbarMenuBorder = $this->params->get('JMtopbarMenuBorder', $this->defaults->get('JMtopbarMenuBorder'));
		$bootstrap_vars['JMtopbarMenuBorder'] = $JMtopbarMenuBorder;

		//menu text
		$JMtopbarMenuFontColor = $this->params->get('JMtopbarMenuFontColor', $this->defaults->get('JMtopbarMenuFontColor'));
		$bootstrap_vars['JMtopbarMenuFontColor'] = $JMtopbarMenuFontColor;

		//menu active text
		$JMtopbarMenuFontColorActive = $this->params->get('JMtopbarMenuFontColorActive', $this->defaults->get('JMtopbarMenuFontColorActive'));
		$bootstrap_vars['JMtopbarMenuFontColorActive'] = $JMtopbarMenuFontColorActive;
		...
		//header bg
		$JMheaderBgOpacity = $this->params->get('JMheaderBgOpacity', $this->defaults->get('JMheaderBgOpacity'));
		$bootstrap_vars['JMheaderBgOpacity'] = $JMheaderBgOpacity;

		$JMheaderBgRepeat = $this->params->get('JMheaderBgRepeat', $this->defaults->get('JMheaderBgRepeat'));
		$bootstrap_vars['JMheaderBgRepeat'] = $JMheaderBgRepeat;

		$JMheaderBgPosition = $this->params->get('JMheaderBgPosition', $this->defaults->get('JMheaderBgPosition'));
		$bootstrap_vars['JMheaderBgPosition'] = $JMheaderBgPosition;

		$JMheaderBgSize = $this->params->get('JMheaderBgSize', $this->defaults->get('JMheaderBgSize'));
		$bootstrap_vars['JMheaderBgSize'] = $JMheaderBgSize;
